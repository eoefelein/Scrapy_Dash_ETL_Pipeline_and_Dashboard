...
# # create us_states list
# us_states = list(us_state_abbrev.keys())
# us_states.remove("Alaska")
# us_states.remove("Hawaii")
# # return only US states
# df = df[df["state"].isin(us_states)]
# # assert outside regions removed
# assert (
#     df["state"].str.contains("Podgorica").sum() == 0
# ), "df contains regions outside US"
